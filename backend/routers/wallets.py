...
class WalletsData(BaseModel):
    ...
    profit_balance: float = None
    vault_balance: float = None
    total_profit: float = None
    total_loss: float = None
    is_paper_trading: bool = None


class WalletsUpdateData(BaseModel):
    """Update entity data (partial updates allowed)"""
    available_balance: Optional[float] = None
    trading_balance: Optional[float] = None
    profit_balance: Optional[float] = None
    vault_balance: Optional[float] = None
